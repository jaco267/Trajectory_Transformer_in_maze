import numpy as np
import torch
from my_conf_maze.utils import discretization
from my_conf_maze.utils.arrays import to_torch
...
class SequenceDataset(torch.utils.data.Dataset):
  def __init__(self, data_path,  N=50, sequence_length=250, step=10, 
    ...
    print(f'[datasets/sequence] Seq len: {sequence_length}, Step: {step}, Max path len: {max_path_length}')       
    ...
    '''
    dataset = VideoDataset(data_path,train=True).get_data()
...
np.ndarray(999999,17) (999999,6)  (999999,17)      (999999,1) (999999,1)     (999999,1)
    ...
    '''
    ## segment
    print(f'[ datasets/sequence ] Segmenting (obs action)...')
    ...
    print("\nok")
    print(f'[ datasets/sequence ] Segmenting (reward)...')
